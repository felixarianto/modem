...
public class Cmd {
    ...
    public String toString() {
        ...
        .append("[").append(service_code).append("] ")
        .append(" mode:").append(svc_request_mode)
        .append(" format:").append(svc_request_format)
        .append(" number:").append(svc_request_source)
        .append(" mode:")  .append(svc_response_mode)
        ...
        .append(" failed:") .append(svc_response_keys_failed).toString();
    }

    String toString(HashMap<String, String> param) {
